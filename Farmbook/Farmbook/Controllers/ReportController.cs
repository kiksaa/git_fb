        ...
        public IList<LandplotReport> GetLandplotList()
        {
            ...
            using (farmdb farmdb = new farmdb())
            {
                ...
                var data = from l in farmdb.landplots
                           ...
                           select new
                           {
                               l.ID, l.plotName, l.coordinatesStar, l.coordinatesEnd, p.provinceName, a.ampherName, d.districtName,
                               r.name, t.ownership, li.licenseName, pro.proName, s.statusName, l.areaPlot, l.areaPlotS, l.active,
                               l.lease_img, l.license_img, th.product, th.workName, l.areaCode, l.landNumber, l.administrator,
                               l.plotDetails, b.nameBuy, ac.activeName, Totalarea = th.product * l.areaPlot, l.note, l.titleDeed,
                               l.landSlip,
                           };
        ...
        public IList<RegisterReport> GetRegisterList()
        {
            ...
            using (farmdb farmdb = new farmdb())
            {
                ...
                var data = from r in farmdb.registers
                           ...
                           select new
                           {
                               r.ID, r.name, r.registerID, r.cardID, r.no, r.moo, r.road, r.card_img, r.farmer_img,
                               p.provinceName, a.ampherName, d.districtName, /*s.statusName,*/ r.dateUpdate, r.adminBy,
                               ac.activeName, g.genderName, r.birthday, r.tel, r.email, f.familyName, r.comment, b.bankName,
            ...
            using (farmdb farmdb = new farmdb())
            {
                ...
                var data = from t in farmdb.theories
                           ...
                           select new
                           {
                               ...
                               t.farmingType, t.type, t.sepecies, t.detail, t.product, p.proName, ac.stepNum, ac.stepName,
                               ac.activity1, ac.notice
                           };
                foreach (var item in data)
                {
                ...
                var data2 = from t in farmdb.theories
                           ...
                           select new
                           {
                               t.ID, t.dateUpdate, t.productType, t.workName, a.accessName, t.reference, tt.theoryName,
                               t.farmingType, t.type, t.sepecies, t.detail, t.product, p.proName, ac.stepNum, ac.stepName,
                               ac.age, ac.time, ac.activity1, ac.notice
                           };
        ...
        public IList<ProjectReport> GetProjectList()
        {
            ...
            using (farmdb farmdb = new farmdb())
            {
                ...
                var data = from p in farmdb.projects
                           ...
                           select new
                           {
                               p.ID, p.dataNow, p.proName, b.nameBuy, s.standardName, p.detail,
                               sl.IDlist, sl.list, sl.img, sl.fillin
                           };
                foreach (var item in data)
                {
        ...
        public IList<EventReport> GetEventList()
        {
            ...
            using (farmdb farmdb = new farmdb())
            {
                ...
                var data = from e in farmdb.events
                           select new
                           {
                               e.ID, e.subject, e.start, e.end, e.description, e.isFullDay
                           };
                foreach (var item in data)
                {
